...
const styles = StyleSheet.create({
  ...
  breakModalCard: { alignSelf: 'center', borderRadius: 18, backgroundColor: '#ffffff', padding: 16, minWidth: 0, maxWidth: '100%' },
  breakModalTitle: { fontSize: 18, fontWeight: '800', color: '#0f172a' },
  breakModalSubtitle: { marginTop: 4, marginBottom: 12, color: '#64748b' },
  breakGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', marginHorizontal: -5 },
  breakOptionButton: { width: 104, borderRadius: 12, borderWidth: 1, borderColor: '#dbe2ea', backgroundColor: '#f8fafc', paddingVertical: 14, alignItems: 'center', marginHorizontal: 5, marginBottom: 10 },
