...
const styles = StyleSheet.create({
  ...
  calendarCard: { borderRadius: 18, backgroundColor: '#ffffff', borderWidth: 1, borderColor: '#e5e7eb', padding: 16, marginBottom: 4 },
  ...
  calendarDay: { width: '14.285%', alignItems: 'center', justifyContent: 'flex-start', borderRadius: 14, marginBottom: 18, paddingTop: 12 },
  ...
  calendarDot: { marginTop: 4, marginBottom: 4, width: 6, height: 6, borderRadius: 3, backgroundColor: '#2563eb' },
  calendarDotActive: { backgroundColor: '#ffffff' },
  calendarFooter: { paddingTop: 12, borderTopWidth: 1, borderTopColor: '#e5e7eb' },
  ...
  sessionCardCompact: { flexDirection: 'column', alignItems: 'stretch' },
  ...
  sessionCardActionsCompact: { marginTop: 12, marginLeft: 0, paddingTop: 0, alignItems: 'flex-end', alignSelf: 'stretch', flexDirection: 'row', justifyContent: 'flex-end' },
  ...
  statusPill: { borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6, marginLeft: 12, flexShrink: 0 },
